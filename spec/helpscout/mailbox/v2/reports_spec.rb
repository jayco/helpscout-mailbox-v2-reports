  ...
  context 'endpoints' do
    ...
    context 'conversations' do
      context 'get_conversations' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations).to raise_error(NotImplementedError)
      ...
      context 'get_conversations_busiest_times' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_busiest_times).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
      ...
      context 'get_conversations_drilldown' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_drilldown).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
      ...
      context 'get_conversations_drilldown_by_field' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_drilldown_by_field).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end

      context 'get_conversations_new_conversations' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_new_conversations).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
      ...
      context 'get_conversations_new_conversations_drilldown' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_new_conversations_drilldown).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
      ...
      context 'get_conversations_received_message_stats' do
        it 'raises an error' do
          expect do
            expect(@client.get_conversations_received_message_stats).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
    end
    ...
    context 'docs' do
      context 'get_docs' do
        it 'raises an error' do
          expect do
            expect(@client.get_docs).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
    end
    ...
    context 'productivity' do
      context 'get_productivity' do
        it 'raises an error' do
          expect do
            expect(@client.get_productivity).to raise_error(NotImplementedError)
          end.to raise_error(NotImplementedError)
        end
      end
